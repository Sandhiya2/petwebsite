...
.drop:hover .btn {
  border-bottom: 3px solid #23E1E1;
}
...
<div class="side-menu animate-dropdown outer-bottom-xs">
    ...
    <div class="drop"><button class="btn"><i class="icon fa fa-angle-down-justify fa-fw"></i><span class="section-title">Sub Categories</span></button>
		<div class="drop-content">
		<?php $sql=mysqli_query($con,"select id,subcategory  from subcategory where categoryid='$id'");

while($row=mysqli_fetch_array($sql))
{
    ?>
                <a href="sub-category.php?scid=<?php echo $row['id'];?>&cid=<?php echo $id;?>" class="dropdown-toggle">
